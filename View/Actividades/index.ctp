<div class="actividades index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('ActividadDescripcion'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($actividade['Actividade']['ActividadDescripcion']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $actividade['Actividade']['id']), array(), __('Are you sure you want to delete # %s?', $actividade['Actividade']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
